...
my_w = tk.Tk()
climbs = tk.Label(my_w, text=str(completedclimbs),bg="#36a6b4",fg="white",font=("Arial", 200,  'bold'))
climbs.place(relx=0.3, rely=0.3, anchor='center')
climbslbl = tk.Label(my_w, text="Climbs\nComplete",bg="#36a6b4",fg="white",font=("Arial", 50,  'bold'))
climbslbl.place(relx=0.3, rely=0.5, anchor='center')
ctg = tk.Label(my_w, text=str(climbstogo),bg="#36a6b4",fg="white",font=("Arial", 200,  'bold'))
ctg.place(relx=0.7, rely=0.3, anchor='center')
ctglbl = tk.Label(my_w, text="Climbs\nto Go",bg="#36a6b4",fg="white",font=("Arial", 50,  'bold'))
ctglbl.place(relx=0.7, rely=0.5, anchor='center')
meters = tk.Label(my_w, text=str(round(completedclimbs*12.9939207048)),bg="#36a6b4",fg="white",font=("Arial", 150,  'bold'))
meters.place(relx=0.3, rely=0.75, anchor='center')
meterslbl = tk.Label(my_w, text="Meters\nClimbed",bg="#36a6b4",fg="white",font=("Arial", 40,  'bold'))
meterslbl.place(relx=0.3, rely=0.9, anchor='center')
mtg = tk.Label(my_w, text=str(round(climbstogo*12.9939207048,1)),bg="#36a6b4",fg="white",font=("Arial", 150,  'bold'))
mtg.place(relx=0.7, rely=0.75, anchor='center')
mtglbl = tk.Label(my_w, text="Meters\nLeft",bg="#36a6b4",fg="white",font=("Arial", 40,  'bold'))
mtglbl.place(relx=0.7, rely=0.9, anchor='center')
title = tk.Label(my_w, text="Basecamp to Summit",bg="#36a6b4",fg="white",font=("Arial", 80, 'bold'))
title.place(relx=0.5, rely=0.05, anchor='center')
alive = tk.Label(my_w, text=alivetime(),bg="#36a6b4",fg="white",font=("Arial", 5,  'bold'))
...
climbinglogo.configure(bg='#36a6b4')
...
phantomlogo.configure(bg='#36a6b4')
